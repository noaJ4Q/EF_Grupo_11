      ...
      <div class="container d-flex align-items-center justify-content-between">
        ...
        <i class="fas fa-search"></i>
            ...
            <li><a class="nav-link" href="<%=request.getContextPath()%>/Inicio?action=misIncidencias">Mis
              Incidencias</a></li>
            <li><a class="nav-link" href="<%=request.getContextPath()%>/Inicio?action=registrarServicio">Registrar
              Servicio</a></li>
              ...
              <div class="row">
                ...
                <div class="col-xl-11">
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <button formaction="<%=request.getContextPath()%>/Inicio?action=registrarImpresion3D">Registrar Impresion 3D </button>
                      <button formaction="<%=request.getContextPath()%>/Inicio?action=registrarCorteLaser">Registrar Corte Laser </button>
                      <button formaction="<%=request.getContextPath()%>/Inicio?action=registrarEscaneo3D">Registrar Escaneo Digital 3D </button>
